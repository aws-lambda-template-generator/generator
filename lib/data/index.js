...
const templateData = [
  // TypeScript
  {
    ...
    templates: [
      ...
      {
        templateId: '5',
        templateName: 'ts-graphql-hello-world',
      ...
      {
        templateId: '6',
        templateName: 'ts-graphql-dynamodb',
      ...
      {
        templateId: '7',
        templateName: 'ts-simple-api-proxy-template-sam-cli',
  ...
  // JavaScript
  {
    ...
    templates: [
      ...
      {
        templateId: '3',
        templateName: 'js-graphql-hello-world',
